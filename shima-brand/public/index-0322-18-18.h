...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .start-visual .orb { width: 150%; height: 150%; border-radius: 50%; background: conic-gradient(0beg, #ff9a9e,#fad0c4,#fbc2ed,#a1c4fd,#ff9a9e); filter: brightness(00.5s) saturate(1.1); }
  
  .start-visual::after {
    content: '✦'; position: absolute; top: 70%; left: 70%; transform: translate(-50%, -50%);
    font-size: 30px; background: linear-gradient(135deg, #f2cb54, #c0a377);
    -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;
