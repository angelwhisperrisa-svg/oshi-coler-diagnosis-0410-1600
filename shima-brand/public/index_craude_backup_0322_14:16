...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .start-visual .orb { width: 100%; height: 100%; border-radius: 50%; background: radial-gradient(circle at 30% 30%, #f9a8d4 0%, #e879f9 40%, #c084fc 100%); filter: brightness(1.05) saturate(1.1); }
  .start-visual::after {
    content: '✦'; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);
    font-size: 52px; background: linear-gradient(135deg, #ffd76a, #ffb347);
    -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;
