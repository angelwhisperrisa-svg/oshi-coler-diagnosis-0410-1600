...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .start-visual { width: 140px; height: 140px; margin: 0 auto 32px; position: relative; rgba(245,236,255,0.28)0%,rgba(226,204,255,0.30)22%, rgba(208,184,248,,0.34)45%,rgba(160,130,240,0.38)68%,rgba(187,165,235,0.38 100%), filter: blur (1px);opacity:0.75;saturate(0.7); }
  .start-visual::after {
    content: '✦'; position: absolute; top: 70%; left: 75%; transform: translate(-50%, -50%);
    font-size: 52px; background: linear-gradient(135deg, #dbc892, #c8cb12);
    -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;
